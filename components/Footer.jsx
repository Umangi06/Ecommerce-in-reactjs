...
const desc =
  "The purpose of this project is to design and develop a user-friendly e-commerce shopping cart system that allows customers to browse and purchase products online.";
